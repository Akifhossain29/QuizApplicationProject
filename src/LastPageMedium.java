...
public class LastPageMedium extends javax.swing.JFrame {
    ...
    /**
     * Creates new form LastPageMedium
     */
    public LastPageMedium() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LastPageMedium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LastPageMedium().setVisible(true);
            }
        });
    }
